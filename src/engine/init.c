...
/*   Updated: 2025/06/18 13:32:48 by ogrativ          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	hook_inputs(t_engine *eng)
{
	...
	mlx_hook(eng->window.win, DestroyNotify, NoEventMask,
		mlx_loop_end, eng->mlx);
	mlx_hook(eng->window.win, MotionNotify, PointerMotionMask,
		input_mouse_move, eng);
	mlx_hook(eng->window.win, KeyPress, KeyPressMask,
		input_keyboard_press, eng);
	mlx_hook(eng->window.win, KeyRelease, KeyReleaseMask,
		input_keyboard_release, eng);
	mlx_hook(eng->window.win, ConfigureNotify, StructureNotifyMask,
		input_event_resize, eng);
