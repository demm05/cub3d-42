...
/*   Updated: 2025/06/30 16:56:51 by ogrativ          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	is_door(t_ray *ray, t_engine *eng, t_door *hit_door)
{
	double	open_side;
	double	left;
	double	right;
...
static bool	handle_door_hit(t_ray *ray, t_engine *eng, t_door *door)
{
	t_door	*nearby;
